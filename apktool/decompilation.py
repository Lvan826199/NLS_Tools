...
class Decompilation():
    ...
    def get_values(self):
        ...
        if ("framework-res.apk" in apktool_file) and ("1.apk" in framework_res):
            ...
            # os.system(f'cd apktool && apktool_2.5.0 if -p D:\Y_Script\rubbish_draft\all_app_charater\NLS_Tools\resources\framework-res  framework-res.apk')
